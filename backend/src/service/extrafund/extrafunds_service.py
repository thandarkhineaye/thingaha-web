...
class ExtrafundsService(Service):
    ...
    def update_extrafund_by_id(self, extrafund_id: int, data: Dict[str, str]) -> bool:
        ...
        try:
            self.logger.info("update address info by id %s", extrafund_id)
            return ExtrafundsModel.update_address(extrafund_id, ExtrafundsModel(
                mmk_amount=data["mmk_amount"],
                transfer_id=data["transfer_id"]))
    ...
    def delete_extrafund_by_id(self, extrafund_id: int) -> bool:
        ...
        try:
            ...
            return ExtrafundsModel.delete_address(extrafund_id)
        except SQLAlchemyError:
    ...
    def get_all_extrafunds(self) -> List[Dict[str, Any]]:
        ...
        try:
            return self.__return_user_list(ExtrafundsModel.get_all_users())
        except SQLAlchemyError:
